...
fig.update_layout(
    ...
    scene=dict(
        ...
        zaxis=dict(title="level n (particle ladder)", color="#5c5870", gridcolor="#150e24"),
...
Image.open(out / "_h_raw.png").resize((1600, 1000), Image.LANCZOS).save(out / "heart-of-law.png")
