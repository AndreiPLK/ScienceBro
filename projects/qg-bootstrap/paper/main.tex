...
\href{https://github.com/AndreiPLK/spacetime-verifier}{github.com/AndreiPLK/spacetime-verifier}.}}
\date{August 2026}
...
at $q=1$ and obtain: (i) the island's left edge is the line
$r=-(1+\mu_0)/2$, exactly, at every level and in every spacetime dimension
$D>3$; (ii) the erosion of finite-depth islands is explained cell by cell by a
...
the $w\neq 0$ region is charted here for the first time.
\end{abstract}
...
Theorem~\ref{thm:edge}, or (iii) a domain pole. This motivates:
...
Total: $11{,}994$ exact verdicts, zero mismatches. What remains unproven is
...
$(2\ell+1)$ scaling is confirmed exactly in numerics up to $n=200$, while the
constant converges logarithmically. This part is heuristic-plus-numeric.
...
ladder). The exponent follows from the exact logarithmic derivative
...
``Uniqueness Criteria for the Veneziano Amplitude,''
arXiv:2406.02665.
