...
$(j{-}1)$-fold degenerate root splits at subleading order into thin
negativity bands --- $(j{-}1)/2$ for odd $j$, $(j{-}2)/2$ plus the first
knife's own semi-infinite dead side for even $j$ --- within the window belt
$\rho<\sqrt{5/3}$. Exact-arithmetic verification: for $j\le8$ and levels up
to $n=100$ inside the belt, every band count matches the prediction with
zero deviations. Minimizing the collapse surface over
...
deviation improves to $O(m^{-\lceil(j-1)/2\rceil})$ (finite-difference
...
fixed $\lambda$ gives the stationarity condition $12\rho-6\rho^2-4=0$,
hence the ratio $\rho^*=1+1/\sqrt3$ and the envelope asymptote
