...
def band(n, lams, col):
    ...
    if not xs:
        return None
    return {"x": xs + xs[::-1], "y": hi + lo[::-1], "fill": "toself",
            "fillcolor": col + "59", "line": {"color": col, "width": 1.8},
...
def closeup():
    ...
    traces = [{"x": lams + lams[::-1], "y": shore + [0] * len(lams),
               "fill": "toself", "fillcolor": "rgba(10,163,194,0.13)",
               "line": {"width": 0}, "mode": "lines", "showlegend": False}]
    for n, col in ((6, "#ff2a6d"), (8, "#c86bd8"), (11, "#5a78e8")):
        b = band(n, lams, col)
        if b:
            traces.append(b)
    traces.append({"x": lams, "y": shore, "mode": "lines",
                   "line": {"color": "#3fe7f5", "width": 6},
                   "showlegend": False})
    traces.append({"x": [1], "y": [23], "mode": "markers",
                   "showlegend": False,
                   "marker": {"color": "#ffffff", "size": 14,
                              "symbol": "diamond",
                              "line": {"color": "#f9f871", "width": 4}}})
    annos = [
        {"x": 4.6, "y": 30, "text": "<b>LIVING LAND</b><br>allowed theories"
         " of gravity<br>(below the shore)", "showarrow": False,
         "font": {"color": "#9ff5ff", "size": 17}, "align": "center"},
        {"x": 1.05, "y": 100, "text": "<b>DEAD LAND</b><br>already excluded"
         " by the shore", "showarrow": False,
         "font": {"color": "#7f93bb", "size": 17}, "align": "center"},
        {"x": 2.45, "y": 62, "text": "<b>THE BLADES</b><br>extra kill-windows"
         " found by the master formula:<br>level 6 (pink), 8 (violet),"
         " 11 (blue) — and so on", "showarrow": False,
         "font": {"color": "#ff5f95", "size": 15}, "align": "center"},
        {"x": 3.6, "y": 83.5, "text": "every blade floats ABOVE the shore"
         " —<br>none ever cuts into the living land<br>(" + BATTERY +
         " exact checks, 0 hits)", "showarrow": False,
         "font": {"color": "#f9f871", "size": 15}, "align": "center"},
        {"x": 1.35, "y": 17.5, "text": "<b>the string</b> — on the"
         " shore at D=23", "showarrow": False,
         "font": {"color": "#f9f871", "size": 15}, "align": "center"},
        {"x": 1, "y": 23, "ax": 40, "ay": 28, "text": "", "showarrow": True,
         "arrowcolor": "#f9f871", "arrowwidth": 2},
    ]
    title = "THE BLADES NEVER TOUCH THE SHORE"
    sub = ("one picture of the whole result: the shore (cyan) divides living"
    ...
    html = PAGE.format(title=title, sub=sub, traces=json.dumps(traces),
                       xr="[0,6.2]", yr="[4,115]",
...
def zoomout():
    ...
    traces = [{"x": lams + lams[::-1], "y": shore + [0] * len(lams),
               "fill": "toself", "fillcolor": "rgba(10,163,194,0.13)",
               "line": {"width": 0}, "mode": "lines", "showlegend": False}]
    cols = {6: "#ff2a6d", 11: "#c86bd8", 20: "#7a5ae0", 35: "#4a78e8",
            60: "#2aa3c8", 100: "#2ac8a8", 160: "#5fe08f"}
    ...
    annos = [
        {"x": 40, "y": 280, "text": "<b>LIVING LAND</b><br>below the shore",
         "showarrow": False, "font": {"color": "#9ff5ff", "size": 18},
         "align": "center"},
        {"x": 8, "y": 880, "text": "<b>DEAD LAND</b>", "showarrow": False,
         "font": {"color": "#7f93bb", "size": 18}, "align": "center"},
        {"x": 22, "y": 700, "text": "the fleet of blades — levels 6, 11,"
         " 20, 35, 60, 100, 160 —<br>sails parallel to the shore, always"
         " above it,<br>drifting further away as λ grows",
         "showarrow": False, "font": {"color": "#ff8fb5", "size": 15},
         "align": "center"},
        {"x": 42, "y": 862, "text": "the shore straightens onto<br>D ="
         " (12+4√3)·λ (paper 2)", "showarrow": False,
         "font": {"color": "#3fe7f5", "size": 14}, "align": "center"},
        {"x": 5.2, "y": 62, "text": "the string, D=23", "showarrow": False,
         "font": {"color": "#f9f871", "size": 13}, "align": "center"},
        {"x": 1.2, "y": 26, "ax": 40, "ay": -14, "text": "",
         "showarrow": True, "arrowcolor": "#f9f871", "arrowwidth": 1.6},
    ]
    title = "ZOOM OUT: THE FLEET OF BLADES"
    sub = ("the same picture from far away: lambda to 50, dimensions to"
